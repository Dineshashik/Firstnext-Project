...
import {
  ...
  InvestorComapanyEditDetailsWrapper,
} from './style';
...
import { signupCompanyInvestorDetailsSchema } from '@/services/schema';
...
const InvestorCompanyEditDetails = ({
  type,
  setEditProfile,
  companyDetails,
}: any) => {
  ...
  const methods = useForm<any>({
    resolver: yupResolver(signupCompanyInvestorDetailsSchema),
    defaultValues: {
      company_docs: companyDetails.company_logo,
...
export default InvestorCompanyEditDetails;
